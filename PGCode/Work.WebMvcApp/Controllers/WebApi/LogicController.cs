...
namespace ProcCore.ApiBusiness
{
...
namespace ProcCore.ApiBusiness.Logic
{
    #region LogicBase
    public class LogicBase : ApiController, IDisposable
    {
        protected CommConnection getSQLConnection()
        {
            ...
            BConn.Path = System.Web.HttpContext.Current.Server.MapPath("~");
        ...
        protected CommConnection Connection { get; set; }
    ...
    public abstract class LogicBase<m_Module, q_Module, TabModule> :ApiController, IDisposable
    {
        protected CommConnection getSQLConnection()
        {
    ...
    public class a_Product : LogicBase<m_Product, q_Product, Product>
    {
        ...
        public override RunQueryPackage<m_Product> SearchMaster(q_Product qr, int accountId)
        {
            ...
            try
            {
                ...
                dataWork.SelectFields((x, y, z) => new { x.id, x.product_name, x.product_serial, x.member_price, x.original_price, x.special_price, x.currency, y.category_l1_name, z.category_l2_name, x.can_sell_amt, x.is_shelf });
    ...
    public class a_Orders : LogicBase<m_Orders, q_Orders, Orders>
    {
        ...
        public RunInsertEnd InsertCross(m_Orders Orders, m_Orders_Detail[] Orders_Details, int accountId)
        {
            ...
            try
            {
                ...
                a_Orders_Detail ac_Orders_Detail = new a_Orders_Detail() { logPlamInfo = logPlamInfo };
    ...
    public class a_NewsController : LogicBase<m_News, q_News, News>
    {
        public a_NewsController() {
