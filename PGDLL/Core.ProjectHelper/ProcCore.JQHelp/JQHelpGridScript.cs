    ...
    public class jqGrid : BaseJqueryScriptHelp, ijQueryUIScript
    {
        ...
        public class colObject : BaseJqueryScriptHelp, ijQueryUIScript
        {
            ...
            public class editOptions : BaseJqueryScriptHelp, ijQueryUIScript
            {
                ...
                funcMethodModule _custom_element;
                public funcMethodModule custom_element
                {
                    get
                    {
                        return _custom_element;
                    }
                    set
                    {
                        _custom_element = value;
                        if (_custom_element != null)
                        {
                            _custom_element.funcParam.AddRange(new String[] { "value", "options" });
                        }
                    }
                }
                funcMethodModule _custom_value;
                public funcMethodModule custom_value { 
                    get { return _custom_value; } 
                    set {
                        _custom_value = value;
                        if (_custom_value != null)
                        {
                            _custom_value.funcParam.AddRange(new String[] { "elem", "operation", "value" });
                        }
                    } 
                }
